...
async def monitor_topic(topic: str, user_id: str, interval_minutes: int = 60):
...
async def organize_memory(user_id: str):
...
async def generate_summary(user_id: str, memory_type: str = "conversation"):
...
async def background_research(query: str, user_id: str):
    from app.services.search import search_service
